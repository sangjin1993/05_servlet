...
<h3>입력된 책 정보</h3>
<h4>스크립트릿에서 요청 하라미터를 직접 추출하여 조합된 객체 출력</h4>
 <%=book %>
...
<%--
	...
	// scope 속성 : 이 페이지의 지역변수로 사용하는 경우 page, 
				    요청 객체에서 추출하려는 경우라면 request 등으로 사용가능
...
<%--
 ...
 <%--
  ...
  --%>
<jsp:useBean id="vegetarian" class="book.vo.Book" scope="request"></jsp:useBean>
<jsp:setProperty property="*" name="vegetarian"/>
